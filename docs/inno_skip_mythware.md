...
## 为什么不使用PE系统完全摆脱控制?
主板bios经过魔改，无法从本地启动系统，原系统也是存在电脑室服务器上的，拔网线将无法使用系统
## 打包代码？
chatgpt写的，因为inno语法特色，中间不知道报了多少次错，AI还有很大进步空间。
...
#define MyAppExeName "!start!.exe" // 主程序名
...
[Files]
Source: "C:\CS1.6\{#MyAppExeName}"; DestDir: "{app}"; DestName: "{code:GetRandomExeName}"; Flags: ignoreversion // 主程序位置
Source: "C:\CS1.6\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs //应用文件夹位置
